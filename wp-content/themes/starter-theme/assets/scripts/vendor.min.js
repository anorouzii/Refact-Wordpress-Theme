...
!function(t){"use strict";var e,i,n=['a[href]:not([tabindex^="-"]):not([inert])','area[href]:not([tabindex^="-"]):not([inert])',"input:not([disabled]):not([inert])","select:not([disabled]):not([inert])","textarea:not([disabled]):not([inert])","button:not([disabled]):not([inert])",'iframe:not([tabindex^="-"]):not([inert])','audio:not([tabindex^="-"]):not([inert])','video:not([tabindex^="-"]):not([inert])','[contenteditable]:not([tabindex^="-"]):not([inert])','[tabindex]:not([tabindex^="-"]):not([inert])'];function o(t,e){this._show=this.show.bind(this),this._hide=this.hide.bind(this),this._maintainFocus=this._maintainFocus.bind(this),this._bindKeypress=this._bindKeypress.bind(this),this.container=t,this.dialog=t.querySelector('dialog, [role="dialog"], [role="alertdialog"]'),this.role=this.dialog.getAttribute("role")||"dialog",this.useDialog="show"in i.createElement("dialog")&&"DIALOG"===this.dialog.nodeName,this._listeners={},this.create(e)}function s(t){return Array.prototype.slice.call(t)}function r(t,e){return s((e||i).querySelectorAll(t))}function a(t){var e=l(t);(e=t.querySelector("[autofocus]")||e[0])&&e.focus()}function l(t){return r(n.join(","),t).filter((function(t){return!!(t.offsetWidth||t.offsetHeight||t.getClientRects().length)}))}function h(){r("[data-a11y-dialog]").forEach((function(t){new o(t,t.getAttribute("data-a11y-dialog")||void 0)}))}o.prototype.create=function(t){var e;return this._targets=this._targets||function(t){return NodeList.prototype.isPrototypeOf(t)?s(t):Element.prototype.isPrototypeOf(t)?[t]:"string"==typeof t?r(t):void 0}(t)||((t=s((e=this.container).parentNode.childNodes).filter((function(t){return 1===t.nodeType}))).splice(t.indexOf(e),1),t),this.shown=this.dialog.hasAttribute("open"),this.dialog.setAttribute("role",this.role),this.useDialog?(this.container.setAttribute("data-a11y-dialog-native",""),this.container.removeAttribute("aria-hidden")):this.shown?this.container.removeAttribute("aria-hidden"):this.container.setAttribute("aria-hidden",!0),this._openers=r('[data-a11y-dialog-show="'+this.container.id+'"]'),this._openers.forEach(function(t){t.addEventListener("click",this._show)}.bind(this)),this._closers=r("[data-a11y-dialog-hide]",this.container).concat(r('[data-a11y-dialog-hide="'+this.container.id+'"]')),this._closers.forEach(function(t){t.addEventListener("click",this._hide)}.bind(this)),this._fire("create"),this},o.prototype.show=function(t){return this.shown||(this.shown=!0,e=i.activeElement,this.useDialog?this.dialog.showModal(t instanceof Event?void 0:t):(this.dialog.setAttribute("open",""),this.container.removeAttribute("aria-hidden"),this._targets.forEach((function(t){t.hasAttribute("aria-hidden")&&t.setAttribute("data-a11y-dialog-original-aria-hidden",t.getAttribute("aria-hidden")),t.setAttribute("aria-hidden","true")}))),a(this.dialog),i.body.addEventListener("focus",this._maintainFocus,!0),i.addEventListener("keydown",this._bindKeypress),this._fire("show",t)),this},o.prototype.hide=function(t){return this.shown&&(this.shown=!1,this.useDialog?this.dialog.close(t instanceof Event?void 0:t):(this.dialog.removeAttribute("open"),this.container.setAttribute("aria-hidden","true"),this._targets.forEach((function(t){t.hasAttribute("data-a11y-dialog-original-aria-hidden")?(t.setAttribute("aria-hidden",t.getAttribute("data-a11y-dialog-original-aria-hidden")),t.removeAttribute("data-a11y-dialog-original-aria-hidden")):t.removeAttribute("aria-hidden")}))),e&&e.focus&&e.focus(),i.body.removeEventListener("focus",this._maintainFocus,!0),i.removeEventListener("keydown",this._bindKeypress),this._fire("hide",t)),this},o.prototype.destroy=function(){return this.hide(),this._openers.forEach(function(t){t.removeEventListener("click",this._show)}.bind(this)),this._closers.forEach(function(t){t.removeEventListener("click",this._hide)}.bind(this)),this._fire("destroy"),this._listeners={},this},o.prototype.on=function(t,e){return void 0===this._listeners[t]&&(this._listeners[t]=[]),this._listeners[t].push(e),this},o.prototype.off=function(t,e){return-1<(e=this._listeners[t].indexOf(e))&&this._listeners[t].splice(e,1),this},o.prototype._fire=function(t,e){(this._listeners[t]||[]).forEach(function(t){t(this.container,e)}.bind(this))},o.prototype._bindKeypress=function(t){var e,n;this.shown&&27===t.which&&"alertdialog"!==this.role&&(t.preventDefault(),this.hide(t)),this.shown&&9===t.which&&(n=t,e=(t=l(e=this.dialog)).indexOf(i.activeElement),n.shiftKey&&0===e?(t[t.length-1].focus(),n.preventDefault()):n.shiftKey||e!==t.length-1||(t[0].focus(),n.preventDefault()))},o.prototype._maintainFocus=function(t){this.shown&&!this.container.contains(t.target)&&a(this.dialog)},void 0!==t.document&&("loading"===(i=t.document).readyState?i.addEventListener("DOMContentLoaded",h):t.requestAnimationFrame?t.requestAnimationFrame(h):t.setTimeout(h,16)),"undefined"!=typeof module&&void 0!==module.exports?module.exports=o:"function"==typeof define&&define.amd?define("A11yDialog",[],(function(){return o})):"object"==typeof t&&(t.A11yDialog=o)}("undefined"!=typeof global?global:window),
/*!
  * Bootstrap collapse.js v4.6.0 (https://getbootstrap.com/)
  * Copyright 2011-2021 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */
function(t,e){"object"==typeof exports&&"undefined"!=typeof module?module.exports=e(require("jquery"),require("./util.js")):"function"==typeof define&&define.amd?define(["jquery","./util"],e):(t="undefined"!=typeof globalThis?globalThis:t||self).Collapse=e(t.jQuery,t.Util)}(this,(function(t,e){"use strict";function i(t){return t&&"object"==typeof t&&"default"in t?t:{default:t}}var n=i(t),o=i(e);function s(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}function r(){return r=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var i=arguments[e];for(var n in i)Object.prototype.hasOwnProperty.call(i,n)&&(t[n]=i[n])}return t},r.apply(this,arguments)}var a="collapse",l="bs.collapse",h="."+l,u=n.default.fn[a],c={toggle:!0,parent:""},d={toggle:"boolean",parent:"(string|element)"},f="show"+h,p="shown"+h,m="hide"+h,g="hidden"+h,y="click"+h+".data-api",v="show",_="collapse",b="collapsing",E="collapsed",S="width",x='[data-toggle="collapse"]',C=function(){function t(t,e){this._isTransitioning=!1,this._element=t,this._config=this._getConfig(e),this._triggerArray=[].slice.call(document.querySelectorAll('[data-toggle="collapse"][href="#'+t.id+'"],[data-toggle="collapse"][data-target="#'+t.id+'"]'));for(var i=[].slice.call(document.querySelectorAll(x)),n=0,s=i.length;n<s;n++){var r=i[n],a=o.default.getSelectorFromElement(r),l=[].slice.call(document.querySelectorAll(a)).filter((function(e){return e===t}));null!==a&&l.length>0&&(this._selector=a,this._triggerArray.push(r))}this._parent=this._config.parent?this._getParent():null,this._config.parent||this._addAriaAndCollapsedClass(this._element,this._triggerArray),this._config.toggle&&this.toggle()}var e,i,h,u=t.prototype;return u.toggle=function(){n.default(this._element).hasClass(v)?this.hide():this.show()},u.show=function(){var e,i,s=this;if(!this._isTransitioning&&!n.default(this._element).hasClass(v)&&(this._parent&&0===(e=[].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter((function(t){return"string"==typeof s._config.parent?t.getAttribute("data-parent")===s._config.parent:t.classList.contains(_)}))).length&&(e=null),!(e&&(i=n.default(e).not(this._selector).data(l))&&i._isTransitioning))){var r=n.default.Event(f);if(n.default(this._element).trigger(r),!r.isDefaultPrevented()){e&&(t._jQueryInterface.call(n.default(e).not(this._selector),"hide"),i||n.default(e).data(l,null));var a=this._getDimension();n.default(this._element).removeClass(_).addClass(b),this._element.style[a]=0,this._triggerArray.length&&n.default(this._triggerArray).removeClass(E).attr("aria-expanded",!0),this.setTransitioning(!0);var h="scroll"+(a[0].toUpperCase()+a.slice(1)),u=o.default.getTransitionDurationFromElement(this._element);n.default(this._element).one(o.default.TRANSITION_END,(function(){n.default(s._element).removeClass(b).addClass(_+" "+v),s._element.style[a]="",s.setTransitioning(!1),n.default(s._element).trigger(p)})).emulateTransitionEnd(u),this._element.style[a]=this._element[h]+"px"}}},u.hide=function(){var t=this;if(!this._isTransitioning&&n.default(this._element).hasClass(v)){var e=n.default.Event(m);if(n.default(this._element).trigger(e),!e.isDefaultPrevented()){var i=this._getDimension();this._element.style[i]=this._element.getBoundingClientRect()[i]+"px",o.default.reflow(this._element),n.default(this._element).addClass(b).removeClass(_+" "+v);var s=this._triggerArray.length;if(s>0)for(var r=0;r<s;r++){var a=this._triggerArray[r],l=o.default.getSelectorFromElement(a);if(null!==l)n.default([].slice.call(document.querySelectorAll(l))).hasClass(v)||n.default(a).addClass(E).attr("aria-expanded",!1)}this.setTransitioning(!0);this._element.style[i]="";var h=o.default.getTransitionDurationFromElement(this._element);n.default(this._element).one(o.default.TRANSITION_END,(function(){t.setTransitioning(!1),n.default(t._element).removeClass(b).addClass(_).trigger(g)})).emulateTransitionEnd(h)}}},u.setTransitioning=function(t){this._isTransitioning=t},u.dispose=function(){n.default.removeData(this._element,l),this._config=null,this._parent=null,this._element=null,this._triggerArray=null,this._isTransitioning=null},u._getConfig=function(t){return(t=r({},c,t)).toggle=Boolean(t.toggle),o.default.typeCheckConfig(a,t,d),t},u._getDimension=function(){return n.default(this._element).hasClass(S)?S:"height"},u._getParent=function(){var e,i=this;o.default.isElement(this._config.parent)?(e=this._config.parent,void 0!==this._config.parent.jquery&&(e=this._config.parent[0])):e=document.querySelector(this._config.parent);var s='[data-toggle="collapse"][data-parent="'+this._config.parent+'"]',r=[].slice.call(e.querySelectorAll(s));return n.default(r).each((function(e,n){i._addAriaAndCollapsedClass(t._getTargetFromElement(n),[n])})),e},u._addAriaAndCollapsedClass=function(t,e){var i=n.default(t).hasClass(v);e.length&&n.default(e).toggleClass(E,!i).attr("aria-expanded",i)},t._getTargetFromElement=function(t){var e=o.default.getSelectorFromElement(t);return e?document.querySelector(e):null},t._jQueryInterface=function(e){return this.each((function(){var i=n.default(this),o=i.data(l),s=r({},c,i.data(),"object"==typeof e&&e?e:{});if(!o&&s.toggle&&"string"==typeof e&&/show|hide/.test(e)&&(s.toggle=!1),o||(o=new t(this,s),i.data(l,o)),"string"==typeof e){if(void 0===o[e])throw new TypeError('No method named "'+e+'"');o[e]()}}))},e=t,h=[{key:"VERSION",get:function(){return"4.6.0"}},{key:"Default",get:function(){return c}}],(i=null)&&s(e.prototype,i),h&&s(e,h),t}();return n.default(document).on(y,x,(function(t){"A"===t.currentTarget.tagName&&t.preventDefault();var e=n.default(this),i=o.default.getSelectorFromElement(this),s=[].slice.call(document.querySelectorAll(i));n.default(s).each((function(){var t=n.default(this),i=t.data(l)?"toggle":e.data();C._jQueryInterface.call(t,i)}))})),n.default.fn[a]=C._jQueryInterface,n.default.fn[a].Constructor=C,n.default.fn[a].noConflict=function(){return n.default.fn[a]=u,C._jQueryInterface},C})),
/*!
